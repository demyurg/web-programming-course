...
export type PostApiCategoriesMutationError =
  | BadRequestResponse
  | UnauthorizedResponse
  | ForbiddenResponse;
...
export const getPutApiCategoriesCategoryIdMutationOptions = <
  TError =
    | BadRequestResponse
    | UnauthorizedResponse
    | ForbiddenResponse
...
export type PutApiCategoriesCategoryIdMutationResult = NonNullable<
  Awaited<ReturnType<typeof putApiCategoriesCategoryId>>
>;
export type PutApiCategoriesCategoryIdMutationBody = UpdateCategoryRequest;
export type PutApiCategoriesCategoryIdMutationError =
  | BadRequestResponse
  | UnauthorizedResponse
  | ForbiddenResponse
  | NotFoundResponse;
 ...
 * @summary Обновить категорию
 */
export const usePutApiCategoriesCategoryId = <
  TError =
    | BadRequestResponse
    | UnauthorizedResponse
    | ForbiddenResponse
...
export const getDeleteApiCategoriesCategoryIdMutationOptions = <
...
export type DeleteApiCategoriesCategoryIdMutationResult = NonNullable<
  Awaited<ReturnType<typeof deleteApiCategoriesCategoryId>>
>;

export type DeleteApiCategoriesCategoryIdMutationError =
  | UnauthorizedResponse
  | ForbiddenResponse
  | NotFoundResponse;
 ...
 * @summary Удалить категорию
 */
export const useDeleteApiCategoriesCategoryId = <
  TError = UnauthorizedResponse | ForbiddenResponse | NotFoundResponse,
  TContext = unknown,
>(
  options?: {
...
> => {
  const mutationOptions =
    getDeleteApiCategoriesCategoryIdMutationOptions(options);
