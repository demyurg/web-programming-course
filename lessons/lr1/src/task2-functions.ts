...
function createProduct(id:number, name:string, price:number, category:Product['category'], inStock?:boolean, tags?:string[]): Product {
    return {
        id,
        name,
        price,
...
function filterProducts(products: Product[], filters: Partial<Product>) {
