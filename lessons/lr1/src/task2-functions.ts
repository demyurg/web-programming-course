...
function createProduct(id: number, name: string, price: number, category:string, inStock:boolean, tags:tags):Product {
    return {
        id,
        name,
        price,
...
function filterProducts(products:Product[], filters:Partial<Filter>) {
