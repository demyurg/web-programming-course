...
// Универсальные utility функции и классы с типами
...
function unique<T, K = T>(array: T[], keyGetter?: (item: T) => K): T[] {
    if (!keyGetter) {
...
class Repository<T extends Identifiable> {
    ...
    update(id: number, updates: Partial<Omit<T, 'id' | 'createdAt' | 'updatedAt'>>): T | null {
...
function merge<T, U>(target: T, ...sources: U[]): T & U {
