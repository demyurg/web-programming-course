...
class Repository<T extends Record<string, any>> {
    ...
    create(data: Omit<T, keyof Entity>): T & Entity {
        const item = {
            id: this.nextId++,
            ...data,
            createdAt: new Date(),
    ...
    findById(id: number): (T & Entity) | undefined {
    ...
    update(id: number, updates: Partial<T>): (T & Entity) | null {
...
function merge<T extends object, U extends object, V extends object>(target: T, source1: U, source2: V): T & U & V;
