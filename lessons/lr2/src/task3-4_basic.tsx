...
// TODO 2.3: Создание Context
const UserContext = createContext<UserContextType | undefined>(undefined);

// TODO 2.4: Компонент UserProvider
  ...
  return (
    <div className="app">
      <header className="app-header">
        ...
        {/* TODO 2.8: Добавляем компонент UserStatus */}
        <UserStatus />
      </header>
