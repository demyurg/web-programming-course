...
const products: Product[] = [
  {
    ...
    name: 'Наушники',
    price: 5990,
    image: 'https://i.pinimg.com/474x/0b/89/aa/0b89aaa7a854b79844ddcd6a00088542.jpg?nii=t'
  },
  {
    id: 2,
    name: 'Смарт-часы',
    price: 12990,
    image: 'https://i.playground.ru/p/W5qccVzaH-Xkco_Pu-LjFg.jpeg'
  }
];
    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {products.map(product => (
          <div key={product.id}>
            <div className = 'bg-white s  hadow-md rounded-lg p-4 hover:shadow-xl transition-shadow'>
