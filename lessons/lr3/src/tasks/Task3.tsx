...
const products = [
  { id: 1, name: 'Ноутбук', price: 89990, rating: 4.8, image: 'src/tasks/laptop.png' },
  { id: 2, name: 'Смартфон', price: 69990, rating: 4.7, image: 'src/tasks/phone.jpg' },
  { id: 3, name: 'Планшет', price: 45990, rating: 4.6, image: 'src/tasks/pad.png' },
  { id: 4, name: 'Наушники', price: 25990, rating: 4.9, image: 'src/tasks/headpods.png' },
  { id: 5, name: 'Часы', price: 18990, rating: 4.5, image: 'src/tasks/smart-watch.jpg' },
  { id: 6, name: 'Камера', price: 125990, rating: 4.9, image: 'src/tasks/camera.jpg' },
];
