...
const buttonClasses : Record<string, string>= {red:"bg-red-500"}
const images = [
  'https://avatars.mds.yandex.net/i?id=7f245b7419315e529cd7a98653ca9a79_l-5221522-images-thumbs&n=13',
  'https://avatars.mds.yandex.net/i?id=7f245b7419315e529cd7a98653ca9a79_l-5221522-images-thumbs&n=13',
  'https://avatars.mds.yandex.net/i?id=7f245b7419315e529cd7a98653ca9a79_l-5221522-images-thumbs&n=13',
  'https://avatars.mds.yandex.net/i?id=7f245b7419315e529cd7a98653ca9a79_l-5221522-images-thumbs&n=13',
];
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <div className = 'flex gap-3'>
            {colors.map(color => (
              <button key={color} className={`${buttonClasses[color]} text-white px-4 py-2 rounded`}>
                {color}
              </button>
            ))}
          </div>
