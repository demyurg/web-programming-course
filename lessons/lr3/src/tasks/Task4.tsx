...
const c = {red: "bg-red-500", blue: "bg-blue-500", green: "bg-green-500", yellow: "bg-yellow-500", purple: "bg-purple-500", pink: "bg-pink-500"}
const images = [
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <div className="flex gap-3 justify-center">
            {colors.map(color => (
              <button key={color} className={ c[color] + " text-white px-4 py-2 rounded"}>
                {color}
              </button>
            ))}
          </div>
