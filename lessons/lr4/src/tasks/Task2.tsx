...
const Task2 = observer(() => {
  const { gameStatus, currentQuestion, selectedAnswer, score, progress, isLastQuestion, correctAnswersCount, currentQuestionIndex, questions
  } = gameStore;
  // gameStore.progress = 0; // TODO: заменить на gameStore.progress
