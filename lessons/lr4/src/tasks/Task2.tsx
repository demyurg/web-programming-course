        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full text-center">
          ...
          <div className="mt-4 bg-green-50 rounded-lg p-4 text-left">
            <p className="text-sm text-green-800">
              <strong>Task 2:</strong> Реализовано с использованием MobX. Компонент автоматически
              обновляется при изменении observable данных.
            </p>
          </div>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-500 to-teal-600 p-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mt-4 bg-white/20 backdrop-blur-sm rounded-lg p-4 text-white">
          <p className="text-sm">
            <strong>MobX:</strong> Компонент обновляется автоматически при изменении observable
            полей — без setState или useState!
          </p>
        </div>
      </div>
    </div>
