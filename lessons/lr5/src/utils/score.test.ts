...
describe('score utils', () => {
  describe('calculateTotalScore', () => {
    ...
    it('handles answers without pointsEarned', () => {
      const answers = [{ questionId: '1', isCorrect: false }];
      expect(calculateTotalScore(answers as any)).toBe(0);
    });

    it('sums negative and positive points', () => {
      const answers = [
  ...
  describe('getCorrectAnswersCount', () => {
    it('counts correct answers', () => {
      ...
      expect(getCorrectAnswersCount(answers as any)).toBe(2);
    });
    ...
    it('returns 0 when all answers are wrong', () => {
      ...
      expect(getCorrectAnswersCount(answers as any)).toBe(0);
    });
  });
  ...
  describe('calculateAccuracy', () => {
    it('calculates percentage of correct answers', () => {
      ...
      expect(calculateAccuracy(answers as any)).toBe(75);
    });

    it('returns 0 for empty array', () => {
      expect(calculateAccuracy([] as any)).toBe(0);
    });
    ...
    it('returns 100 when all correct', () => {
      ...
      expect(calculateAccuracy(answers as any)).toBe(100);
    });
  });
});
