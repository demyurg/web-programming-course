...
VALUES (lower(hex(randomblob(16))), 'General', 'general', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO "Question" ("id", "text", "type", "categoryId", "correctAnswer", "points", "createdAt", "updatedAt")
VALUES (
  lower(hex(randomblob(16))),
  '2+2=?',
  'single-select',
  (SELECT "id" FROM "Category" WHERE "slug" = 'general' LIMIT 1),
  '"4"',
  1,
  CURRENT_TIMESTAMP,
  CURRENT_TIMESTAMP
